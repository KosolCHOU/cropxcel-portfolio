...
export default function TeamCard({ name, role, imageUrl, bio, socialLinks }: TeamCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
      {/* Profile Image */}
      <div className="relative h-64 bg-gradient-to-br from-emerald-500 to-teal-400 overflow-hidden">
